...
module ST_SPHD_HIPERF_8192x32m16_Tlmr_1 (A, ATP, CK, CSN, D , IG, INITN , Q, SCTRLI,SCTRLO,SDLI,SDLO,SDRI,SDRO,SE,  STDBY ,TA,TBIST, TBYPASS ,TCSN,TED  ,TOD  , TWEN, WEN);
    ...
    parameter
        ...
        File_load_time=0,
        InstancePath = "ST_SPHD_HIPERF_8192x32m16_Tlmr_1",
...
/*---------------------- Timing Checks ---------------------*/
	...
	$setup(posedge A[12], posedge CK &&& cond_sdf_tas , tas, TimingViol_addr);
	...
	$setup(negedge A[12], posedge CK &&& cond_sdf_tas , tas, TimingViol_addr);
	...
	$hold(posedge CK &&& cond_sdf_tas, posedge A[12], tah, TimingViol_addr);
	...
	$hold(posedge CK &&& cond_sdf_tas, negedge A[12], tah, TimingViol_addr);
	...
	$setup(posedge TA[12], posedge CK &&& cond_sdf_tbas , tbas, TimingViol_addr);
	...
	$setup(negedge TA[12], posedge CK &&& cond_sdf_tbas , tbas, TimingViol_addr);
	...
	$hold(posedge CK &&& cond_sdf_tbas, posedge TA[12], tbah, TimingViol_addr);
	...
	$hold(posedge CK &&& cond_sdf_tbas, negedge TA[12], tbah, TimingViol_addr);
...
ST_SPHD_HIPERF_8192x32m16_Tlmr_MUXprim SLEEP_MUX (vddmo_int,1'b0,SLEEP_buf,SLEEP_gated);
...
ST_SPHD_HIPERF_8192x32m16_Tlmr_SWprim switch_pswsmallma (pswsmallma_close,vddma_int,vddmai_small);
ST_SPHD_HIPERF_8192x32m16_Tlmr_SWprim switch_pswlargema (pswlargema_close,vddma_int,vddmai_large);
ST_SPHD_HIPERF_8192x32m16_Tlmr_WANDprim wand_vddmai (vddmai_int,vddmai_small,vddmai_large);
...
ST_SPHD_HIPERF_8192x32m16_Tlmr_SWprim switch_pswsmallmp (pswsmallmp_close,vddmp_int,vddmpi_small);
ST_SPHD_HIPERF_8192x32m16_Tlmr_SWprim switch_pswlargemp (pswlargemp_close,vddmp_int,vddmpi_large);
ST_SPHD_HIPERF_8192x32m16_Tlmr_WANDprim wand_vddmpi (vddmpi_int,vddmpi_small,vddmpi_large);
...
/*------------------------------------------------------------------------------------------
            ST_SPHD_HIPERF_8192x32m16_Tlmr model for Verilog (inst 2)
-------------------------------------------------------------------------------------------*/
...
module ST_SPHD_HIPERF_8192x32m16_Tlmr_2 (A, ATP, CK, CSN, D , IG, INITN , Q, SCTRLI,SCTRLO,SDLI,SDLO,SDRI,SDRO,SE,  STDBY ,TA,TBIST, TBYPASS ,TCSN,TED  ,TOD  , TWEN, WEN);
    ...
    parameter
        ...
        MEM_INITIALIZE  = 1'b1,
        BinaryInit = 1'b1,
        InitFileName = "ST_SPHD_HIPERF_8192x32m16_Tlmr_2.cde",
        Debug_mode = "all_warning_mode",
        File_load_time=0,
        InstancePath = "ST_SPHD_HIPERF_8192x32m16_Tlmr_2",
...
module ST_SPHD_HIPERF_8192x32m16_Tlmr_3 (A, ATP, CK, CSN, D , IG, INITN , Q, SCTRLI,SCTRLO,SDLI,SDLO,SDRI,SDRO,SE,  STDBY ,TA,TBIST, TBYPASS ,TCSN,TED  ,TOD  , TWEN, WEN);
    ...
    parameter
        ...
        MEM_INITIALIZE  = 1'b1,
        BinaryInit = 1'b1,
        InitFileName = "ST_SPHD_HIPERF_8192x32m16_Tlmr_3.cde",
        Debug_mode = "all_warning_mode",
        File_load_time=0,
        InstancePath = "ST_SPHD_HIPERF_8192x32m16_Tlmr_3",
...
Q_CORE, Q, MEM_EN_inst
    ...
    localparam max_address_bits = 13;
    localparam Addr = 13;
    localparam bits =32;
    localparam words = 8192;
...
ST_SPHD_HIPERF_8192x32m16_Tlmr_CGCprim cgc_CK_bypass (.EN(capt_byp_en_inst), .CK(CK), .CK_gated(CK_bypass));
...
module ST_SPHD_HIPERF_8192x32m16_Tlmr_WANDprim (out,in1,in2);
input in1,in2;
output out;
