...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_wrapper (A, CK, CSN, D, INITN, Q, WEN);
...
ST_SPHD_HIPERF_1024x32m4_Tlmr I1 (.A(A), .ATP(ATP), .CK(CK), .CSN(CSN), .D(D), .IG(IG), .INITN(INITN) , .Q(Q), .SCTRLI(SCTRLI), .SCTRLO(SCTRLO), .SDLI(SDLI), .SDLO(SDLO), .SDRI(SDRI), .SDRO(SDRO), .SE(SE),  .STDBY(STDBY) , .TA(TA), .TBIST(TBIST), .TBYPASS(TBYPASS) , .TCSN(TCSN), .TED(TED) , .TOD(TOD), .TWEN(TWEN), .WEN(WEN));
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_wrapper (A, CK, CSN, D, INITN, Q, WEN);
...
ST_SPHD_HIPERF_3072x32m8_Tlmr I1 (.A(A), .ATP(ATP), .CK(CK), .CSN(CSN), .D(D), .IG(IG), .INITN(INITN) , .Q(Q), .SCTRLI(SCTRLI), .SCTRLO(SCTRLO), .SDLI(SDLI), .SDLO(SDLO), .SDRI(SDRI), .SDRO(SDRO), .SE(SE),  .STDBY(STDBY) , .TA(TA), .TBIST(TBIST), .TBYPASS(TBYPASS) , .TCSN(TCSN), .TED(TED) , .TOD(TOD), .TWEN(TWEN), .WEN(WEN));
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_wrapper (A, CK, CSN, D, INITN, Q, WEN);
...
ST_SPHD_HIPERF_2048x32m8_Tlmr I1 (.A(A), .ATP(ATP), .CK(CK), .CSN(CSN), .D(D), .IG(IG), .INITN(INITN) , .Q(Q), .SCTRLI(SCTRLI), .SCTRLO(SCTRLO), .SDLI(SDLI), .SDLO(SDLO), .SDRI(SDRI), .SDRO(SDRO), .SE(SE),  .STDBY(STDBY) , .TA(TA), .TBIST(TBIST), .TBYPASS(TBYPASS) , .TCSN(TCSN), .TED(TED) , .TOD(TOD), .TWEN(TWEN), .WEN(WEN));
