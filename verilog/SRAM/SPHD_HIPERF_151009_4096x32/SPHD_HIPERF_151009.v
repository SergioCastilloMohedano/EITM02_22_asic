...
/*------------------------------------------------------------------------------------------
            ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT model for Verilog 
-------------------------------------------------------------------------------------------*/
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_INTERFACE IO (
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_0  (.D(ctrl_scff_in[0]), .TI(SCTRLI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[0]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_1 (.D(ctrl_scff_in[1]), .TI(ctrl_scff_out[0]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[1]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_2 (.D(ctrl_scff_in[2]), .TI(ctrl_scff_out[1]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[2]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_3 (.D(ctrl_scff_in[3]), .TI(ctrl_scff_out[2]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[3]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_4 (.D(ctrl_scff_in[4]), .TI(ctrl_scff_out[3]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[4]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_5 (.D(ctrl_scff_in[5]), .TI(ctrl_scff_out[4]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[5]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_6 (.D(ctrl_scff_in[6]), .TI(ctrl_scff_out[5]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[6]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_7 (.D(ctrl_scff_in[7]), .TI(ctrl_scff_out[6]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[7]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_8 (.D(ctrl_scff_in[8]), .TI(ctrl_scff_out[7]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[8]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_9 (.D(ctrl_scff_in[9]), .TI(ctrl_scff_out[8]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[9]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_10 (.D(ctrl_scff_in[10]), .TI(ctrl_scff_out[9]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[10]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_11 (.D(ctrl_scff_in[11]), .TI(ctrl_scff_out[10]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[11]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_12 (.D(ctrl_scff_in[12]), .TI(ctrl_scff_out[11]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[12]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_13 (.D(ctrl_scff_in[13]), .TI(ctrl_scff_out[12]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[13]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_14 (.D(ctrl_scff_in[14]), .TI(ctrl_scff_out[13]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[14]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_15 (.D(ctrl_scff_in[15]), .TI(ctrl_scff_out[14]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[15]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_ctrl_16 (.D(ctrl_scff_in[16]), .TI(ctrl_scff_out[15]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[16]));

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_lock_up_latch  latch_SCTRLO (.CK(!CK_lock_up_latch), .D(ctrl_scff_out[16]), .Q(SCTRLO_temp));
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_0 (.D(D_bmux[15]), .TI(SDLI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[15])); 


 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_1 (.D(D_bmux[14]),  .TI(D_scff_out[15]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[14]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_2 (.D(D_bmux[13]),  .TI(D_scff_out[14]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[13]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_3 (.D(D_bmux[12]),  .TI(D_scff_out[13]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[12]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_4 (.D(D_bmux[11]),  .TI(D_scff_out[12]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[11]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_5 (.D(D_bmux[10]),  .TI(D_scff_out[11]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[10]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_6 (.D(D_bmux[9]),  .TI(D_scff_out[10]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[9]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_7 (.D(D_bmux[8]),  .TI(D_scff_out[9]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[8]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_8 (.D(D_bmux[7]),  .TI(D_scff_out[8]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[7]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_9 (.D(D_bmux[6]),  .TI(D_scff_out[7]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[6]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_10 (.D(D_bmux[5]),  .TI(D_scff_out[6]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[5]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_11 (.D(D_bmux[4]),  .TI(D_scff_out[5]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[4]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_12 (.D(D_bmux[3]),  .TI(D_scff_out[4]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[3]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_13 (.D(D_bmux[2]),  .TI(D_scff_out[3]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[2]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_14 (.D(D_bmux[1]),  .TI(D_scff_out[2]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[1]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_left_15 (.D(D_bmux[0]),  .TI(D_scff_out[1]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[0])); 

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_lock_up_latch  latch_SDLO (.CK(!CK_lock_up_latch), .D(D_scff_out[0]), .Q(SDLO_temp)); 
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_0 (.D(D_bmux[31]), .TI(SDRI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[31])); 

 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_1 (.D(D_bmux[30]),  .TI(D_scff_out[31]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[30]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_2 (.D(D_bmux[29]),  .TI(D_scff_out[30]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[29]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_3 (.D(D_bmux[28]),  .TI(D_scff_out[29]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[28]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_4 (.D(D_bmux[27]),  .TI(D_scff_out[28]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[27]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_5 (.D(D_bmux[26]),  .TI(D_scff_out[27]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[26]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_6 (.D(D_bmux[25]),  .TI(D_scff_out[26]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[25]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_7 (.D(D_bmux[24]),  .TI(D_scff_out[25]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[24]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_8 (.D(D_bmux[23]),  .TI(D_scff_out[24]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[23]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_9 (.D(D_bmux[22]),  .TI(D_scff_out[23]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[22]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_10 (.D(D_bmux[21]),  .TI(D_scff_out[22]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[21]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_11 (.D(D_bmux[20]),  .TI(D_scff_out[21]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[20]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_12 (.D(D_bmux[19]),  .TI(D_scff_out[20]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[19]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_13 (.D(D_bmux[18]),  .TI(D_scff_out[19]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[18]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_14 (.D(D_bmux[17]),  .TI(D_scff_out[18]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[17]));
 ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF scff_data_right_15 (.D(D_bmux[16]),  .TI(D_scff_out[17]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[16])); 

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_lock_up_latch  latch_SDRO (.CK(!CK_lock_up_latch), .D(D_scff_out[16]), .Q(SDRO_temp));
...
wire dCK,dCSN,dIG ,dSE,dSCTRLI,dSDLI,dSDRI   ,dTBYPASS, dWEN;
...
assign cond_sdf_tcycle=((cond_gac && cycle_en) !==0) ? 1:0;  
...
assign cond_sdf_taa=((MEMEN_reg && WEN_bmux_reg && !rta_en_cond) !==0) ? 1:0; 



assign cond_sdf_taa_tm=((INITNandnotSLEEPandATPandnotSE && TBYPASS_buf) !==0) ? 1:0;
...
/*---------------------- Timing Checks ---------------------*/
	...
	$setup(posedge A[11], posedge CK &&& cond_sdf_tas , tas, TimingViol_addr);
	...
	$setup(negedge A[11], posedge CK &&& cond_sdf_tas , tas, TimingViol_addr);
	...
	$hold(posedge CK &&& cond_sdf_tas, posedge A[11], tah, TimingViol_addr);
	...
	$hold(posedge CK &&& cond_sdf_tas, negedge A[11], tah, TimingViol_addr);
	...
	$setup(posedge TA[11], posedge CK &&& cond_sdf_tbas , tbas, TimingViol_addr);
	...
	$setup(negedge TA[11], posedge CK &&& cond_sdf_tbas , tbas, TimingViol_addr);
	...
	$hold(posedge CK &&& cond_sdf_tbas, posedge TA[11], tbah, TimingViol_addr);
	...
	$hold(posedge CK &&& cond_sdf_tbas, negedge TA[11], tbah, TimingViol_addr);
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim SLEEP_MUX (vddmo_int,1'b0,SLEEP_buf,SLEEP_gated);
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim switch_pswsmallma (pswsmallma_close,vddma_int,vddmai_small);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim switch_pswlargema (pswlargema_close,vddma_int,vddmai_large);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_WANDprim wand_vddmai (vddmai_int,vddmai_small,vddmai_large);
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim switch_pswsmallmp (pswsmallmp_close,vddmp_int,vddmpi_small);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim switch_pswlargemp (pswlargemp_close,vddmp_int,vddmpi_large);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_WANDprim wand_vddmpi (vddmpi_int,vddmpi_small,vddmpi_large);
...
assign DE_temp = (LSint === 1'bx || (LSint === 1'b0 && HSint === 1'bx)) ? 1'bx : 1'b0;
...
wire red_en = 0;
wire [repair_address_width-1 : 0] repair_add = 9'b0;
wire [repair_address_width-1 : 0] next_repair_add = 9'b0;
...
begin
     `ifdef ST_MEM_SLM
          if (repair_access === 0) $slm_WriteMemory(slm_handle, A_bmux, D_bmux);
     `else
...
module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_INTERFACE (
// functional inputs
...
Q_CORE, Q, MEM_EN_inst
    ...
    localparam repair_address_width = 9;
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim CSN_bistmux (ATP_TBIST, CSN, TCSN, CSN_bmux_temp);
buf (CSN_scff_din, CSN_bmux_temp);

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim WEN_bistmux (ATP_TBIST, WEN, TWEN, WEN_bmux_temp);
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_0 (ATP_TBIST, A[0], TA[0], A_bmux[0]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_1 (ATP_TBIST, A[1], TA[1], A_bmux[1]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_2 (ATP_TBIST, A[2], TA[2], A_bmux[2]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_3 (ATP_TBIST, A[3], TA[3], A_bmux[3]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_4 (ATP_TBIST, A[4], TA[4], A_bmux[4]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_5 (ATP_TBIST, A[5], TA[5], A_bmux[5]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_6 (ATP_TBIST, A[6], TA[6], A_bmux[6]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_7 (ATP_TBIST, A[7], TA[7], A_bmux[7]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_8 (ATP_TBIST, A[8], TA[8], A_bmux[8]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_9 (ATP_TBIST, A[9], TA[9], A_bmux[9]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_10 (ATP_TBIST, A[10], TA[10], A_bmux[10]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim addr_bistmux_11 (ATP_TBIST, A[11], TA[11], A_bmux[11]);

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_0 (ATP_TBIST,D[0], TED, D_bmux[0]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_1 (ATP_TBIST,D[1], TOD, D_bmux[1]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_2 (ATP_TBIST,D[2], TED, D_bmux[2]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_3 (ATP_TBIST,D[3], TOD, D_bmux[3]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_4 (ATP_TBIST,D[4], TED, D_bmux[4]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_5 (ATP_TBIST,D[5], TOD, D_bmux[5]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_6 (ATP_TBIST,D[6], TED, D_bmux[6]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_7 (ATP_TBIST,D[7], TOD, D_bmux[7]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_8 (ATP_TBIST,D[8], TED, D_bmux[8]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_9 (ATP_TBIST,D[9], TOD, D_bmux[9]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_10 (ATP_TBIST,D[10], TED, D_bmux[10]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_11 (ATP_TBIST,D[11], TOD, D_bmux[11]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_12 (ATP_TBIST,D[12], TED, D_bmux[12]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_13 (ATP_TBIST,D[13], TOD, D_bmux[13]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_14 (ATP_TBIST,D[14], TED, D_bmux[14]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_15 (ATP_TBIST,D[15], TOD, D_bmux[15]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_16 (ATP_TBIST,D[16], TED, D_bmux[16]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_17 (ATP_TBIST,D[17], TOD, D_bmux[17]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_18 (ATP_TBIST,D[18], TED, D_bmux[18]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_19 (ATP_TBIST,D[19], TOD, D_bmux[19]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_20 (ATP_TBIST,D[20], TED, D_bmux[20]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_21 (ATP_TBIST,D[21], TOD, D_bmux[21]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_22 (ATP_TBIST,D[22], TED, D_bmux[22]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_23 (ATP_TBIST,D[23], TOD, D_bmux[23]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_24 (ATP_TBIST,D[24], TED, D_bmux[24]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_25 (ATP_TBIST,D[25], TOD, D_bmux[25]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_26 (ATP_TBIST,D[26], TED, D_bmux[26]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_27 (ATP_TBIST,D[27], TOD, D_bmux[27]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_28 (ATP_TBIST,D[28], TED, D_bmux[28]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_29 (ATP_TBIST,D[29], TOD, D_bmux[29]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_30 (ATP_TBIST,D[30], TED, D_bmux[30]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim data_bistmux_31 (ATP_TBIST,D[31], TOD, D_bmux[31]);
...
// Clock Gating Logic
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_CGCprim cgc_CK_scff (.EN(shift_or_capt_inst), .CK(CK), .CK_gated(CK_scff));

// Clock for lock-up-latch at the end of scan chains... (scan shift mode)
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_CGCprim cgc_CK_lkp_latch (.EN(shift_en_inst), .CK(CK), .CK_gated(CK_lock_up_latch));
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_CGCprim cgc_CK_rw (.EN(MEM_EN_inst), .CK(CK), .CK_gated(CK_rw));
...
// ----- Mem Enable signal -----
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_DFFprim_blocking dff_mem_en (1'b0, bypass_en, CK_rw, MEM_EN_inst, MEMEN_reg_temp);
and (MEMEN_reg, MEMEN_reg_temp, !bypass_en); // To Avoid 'Z' violations


// ---- bypass enable signal -----
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_DLATprim dlat_se (1'b0, 1'b0, !CK, SEint, SE_lat);


and (capt_byp_en_inst, GAC, ATP, !SEint, TBYPASSint, !BYP_ENint);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_CGCprim cgc_CK_bypass (.EN(capt_byp_en_inst), .CK(CK), .CK_gated(CK_bypass));
...
--------------------------------------------------------------------*/
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_outputmux omux (.Q(Q), .D_scff_out(D_scff_out), .bypass_en(bypass_en), .Q_CORE(Q_CORE), .MEMEN_reg(MEMEN_reg));
...
module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_outputmux ( Q, D_scff_out, bypass_en, Q_CORE, MEMEN_reg);
...
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_0 (MEMEN_reg, Q_CORE[0], Q[0]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_1 (MEMEN_reg, Q_CORE[1], Q[1]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_2 (MEMEN_reg, Q_CORE[2], Q[2]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_3 (MEMEN_reg, Q_CORE[3], Q[3]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_4 (MEMEN_reg, Q_CORE[4], Q[4]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_5 (MEMEN_reg, Q_CORE[5], Q[5]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_6 (MEMEN_reg, Q_CORE[6], Q[6]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_7 (MEMEN_reg, Q_CORE[7], Q[7]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_8 (MEMEN_reg, Q_CORE[8], Q[8]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_9 (MEMEN_reg, Q_CORE[9], Q[9]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_10 (MEMEN_reg, Q_CORE[10], Q[10]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_11 (MEMEN_reg, Q_CORE[11], Q[11]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_12 (MEMEN_reg, Q_CORE[12], Q[12]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_13 (MEMEN_reg, Q_CORE[13], Q[13]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_14 (MEMEN_reg, Q_CORE[14], Q[14]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_15 (MEMEN_reg, Q_CORE[15], Q[15]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_16 (MEMEN_reg, Q_CORE[16], Q[16]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_17 (MEMEN_reg, Q_CORE[17], Q[17]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_18 (MEMEN_reg, Q_CORE[18], Q[18]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_19 (MEMEN_reg, Q_CORE[19], Q[19]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_20 (MEMEN_reg, Q_CORE[20], Q[20]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_21 (MEMEN_reg, Q_CORE[21], Q[21]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_22 (MEMEN_reg, Q_CORE[22], Q[22]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_23 (MEMEN_reg, Q_CORE[23], Q[23]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_24 (MEMEN_reg, Q_CORE[24], Q[24]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_25 (MEMEN_reg, Q_CORE[25], Q[25]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_26 (MEMEN_reg, Q_CORE[26], Q[26]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_27 (MEMEN_reg, Q_CORE[27], Q[27]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_28 (MEMEN_reg, Q_CORE[28], Q[28]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_29 (MEMEN_reg, Q_CORE[29], Q[29]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_30 (MEMEN_reg, Q_CORE[30], Q[30]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim memory_path_31 (MEMEN_reg, Q_CORE[31], Q[31]);

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_0 (bypass_en, D_scff_out[0], Q[0]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_1 (bypass_en, D_scff_out[1], Q[1]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_2 (bypass_en, D_scff_out[2], Q[2]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_3 (bypass_en, D_scff_out[3], Q[3]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_4 (bypass_en, D_scff_out[4], Q[4]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_5 (bypass_en, D_scff_out[5], Q[5]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_6 (bypass_en, D_scff_out[6], Q[6]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_7 (bypass_en, D_scff_out[7], Q[7]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_8 (bypass_en, D_scff_out[8], Q[8]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_9 (bypass_en, D_scff_out[9], Q[9]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_10 (bypass_en, D_scff_out[10], Q[10]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_11 (bypass_en, D_scff_out[11], Q[11]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_12 (bypass_en, D_scff_out[12], Q[12]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_13 (bypass_en, D_scff_out[13], Q[13]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_14 (bypass_en, D_scff_out[14], Q[14]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_15 (bypass_en, D_scff_out[15], Q[15]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_16 (bypass_en, D_scff_out[16], Q[16]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_17 (bypass_en, D_scff_out[17], Q[17]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_18 (bypass_en, D_scff_out[18], Q[18]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_19 (bypass_en, D_scff_out[19], Q[19]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_20 (bypass_en, D_scff_out[20], Q[20]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_21 (bypass_en, D_scff_out[21], Q[21]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_22 (bypass_en, D_scff_out[22], Q[22]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_23 (bypass_en, D_scff_out[23], Q[23]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_24 (bypass_en, D_scff_out[24], Q[24]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_25 (bypass_en, D_scff_out[25], Q[25]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_26 (bypass_en, D_scff_out[26], Q[26]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_27 (bypass_en, D_scff_out[27], Q[27]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_28 (bypass_en, D_scff_out[28], Q[28]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_29 (bypass_en, D_scff_out[29], Q[29]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_30 (bypass_en, D_scff_out[30], Q[30]);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim bypass_path_31 (bypass_en, D_scff_out[31], Q[31]);
...
module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_WANDprim (out,in1,in2);
input in1,in2;
output out;
...
module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim (SEL, A, B, Z);
input SEL, A, B;
output Z;
...
module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_CGCprim (EN, CK, CK_gated);
input EN, CK;
output reg CK_gated;
reg last_CK;
...
module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_lock_up_latch (CK, D, Q);
input CK,D;
output Q;

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_DLATprim dlat_lockup (1'b0, 1'b0, CK, D, Q);

endmodule

module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SCFF (D,TI,TE,CP,Q);
input D,TI,TE,CP;
output Q;

ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_MUXprim mux_in_scff (TE, D, TI, temp);
ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_DFFprim dff_in_scff (1'b0, 1'b0, CP, temp, Q);

endmodule

module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_DFFprim (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg Qtemp, last_CK;
...
module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_DFFprim_blocking (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg last_CK;
...
module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_DLATprim (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg Qprev;
...
module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT_SWprim (control,in,out);
output out;
input control,in;
...
/*------------------------------------------------------------------------------------------
            ST_SPHD_HIPERF_1024x32m4_Tlmr model for Verilog 
-------------------------------------------------------------------------------------------*/
...
ST_SPHD_HIPERF_1024x32m4_Tlmr_INTERFACE IO (
...
ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_0  (.D(ctrl_scff_in[0]), .TI(SCTRLI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[0]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_1 (.D(ctrl_scff_in[1]), .TI(ctrl_scff_out[0]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[1]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_2 (.D(ctrl_scff_in[2]), .TI(ctrl_scff_out[1]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[2]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_3 (.D(ctrl_scff_in[3]), .TI(ctrl_scff_out[2]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[3]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_4 (.D(ctrl_scff_in[4]), .TI(ctrl_scff_out[3]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[4]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_5 (.D(ctrl_scff_in[5]), .TI(ctrl_scff_out[4]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[5]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_6 (.D(ctrl_scff_in[6]), .TI(ctrl_scff_out[5]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[6]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_7 (.D(ctrl_scff_in[7]), .TI(ctrl_scff_out[6]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[7]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_8 (.D(ctrl_scff_in[8]), .TI(ctrl_scff_out[7]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[8]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_9 (.D(ctrl_scff_in[9]), .TI(ctrl_scff_out[8]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[9]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_10 (.D(ctrl_scff_in[10]), .TI(ctrl_scff_out[9]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[10]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_11 (.D(ctrl_scff_in[11]), .TI(ctrl_scff_out[10]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[11]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_12 (.D(ctrl_scff_in[12]), .TI(ctrl_scff_out[11]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[12]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_13 (.D(ctrl_scff_in[13]), .TI(ctrl_scff_out[12]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[13]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_14 (.D(ctrl_scff_in[14]), .TI(ctrl_scff_out[13]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[14]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_15 (.D(ctrl_scff_in[15]), .TI(ctrl_scff_out[14]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[15]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_ctrl_16 (.D(ctrl_scff_in[16]), .TI(ctrl_scff_out[15]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[16]));

ST_SPHD_HIPERF_1024x32m4_Tlmr_lock_up_latch  latch_SCTRLO (.CK(!CK_lock_up_latch), .D(ctrl_scff_out[16]), .Q(SCTRLO_temp));
...
ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_0 (.D(D_bmux[15]), .TI(SDLI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[15])); 


 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_1 (.D(D_bmux[14]),  .TI(D_scff_out[15]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[14]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_2 (.D(D_bmux[13]),  .TI(D_scff_out[14]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[13]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_3 (.D(D_bmux[12]),  .TI(D_scff_out[13]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[12]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_4 (.D(D_bmux[11]),  .TI(D_scff_out[12]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[11]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_5 (.D(D_bmux[10]),  .TI(D_scff_out[11]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[10]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_6 (.D(D_bmux[9]),  .TI(D_scff_out[10]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[9]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_7 (.D(D_bmux[8]),  .TI(D_scff_out[9]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[8]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_8 (.D(D_bmux[7]),  .TI(D_scff_out[8]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[7]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_9 (.D(D_bmux[6]),  .TI(D_scff_out[7]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[6]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_10 (.D(D_bmux[5]),  .TI(D_scff_out[6]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[5]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_11 (.D(D_bmux[4]),  .TI(D_scff_out[5]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[4]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_12 (.D(D_bmux[3]),  .TI(D_scff_out[4]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[3]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_13 (.D(D_bmux[2]),  .TI(D_scff_out[3]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[2]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_14 (.D(D_bmux[1]),  .TI(D_scff_out[2]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[1]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_left_15 (.D(D_bmux[0]),  .TI(D_scff_out[1]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[0])); 

ST_SPHD_HIPERF_1024x32m4_Tlmr_lock_up_latch  latch_SDLO (.CK(!CK_lock_up_latch), .D(D_scff_out[0]), .Q(SDLO_temp)); 
...
ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_0 (.D(D_bmux[31]), .TI(SDRI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[31])); 

 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_1 (.D(D_bmux[30]),  .TI(D_scff_out[31]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[30]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_2 (.D(D_bmux[29]),  .TI(D_scff_out[30]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[29]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_3 (.D(D_bmux[28]),  .TI(D_scff_out[29]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[28]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_4 (.D(D_bmux[27]),  .TI(D_scff_out[28]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[27]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_5 (.D(D_bmux[26]),  .TI(D_scff_out[27]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[26]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_6 (.D(D_bmux[25]),  .TI(D_scff_out[26]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[25]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_7 (.D(D_bmux[24]),  .TI(D_scff_out[25]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[24]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_8 (.D(D_bmux[23]),  .TI(D_scff_out[24]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[23]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_9 (.D(D_bmux[22]),  .TI(D_scff_out[23]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[22]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_10 (.D(D_bmux[21]),  .TI(D_scff_out[22]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[21]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_11 (.D(D_bmux[20]),  .TI(D_scff_out[21]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[20]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_12 (.D(D_bmux[19]),  .TI(D_scff_out[20]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[19]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_13 (.D(D_bmux[18]),  .TI(D_scff_out[19]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[18]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_14 (.D(D_bmux[17]),  .TI(D_scff_out[18]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[17]));
 ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF scff_data_right_15 (.D(D_bmux[16]),  .TI(D_scff_out[17]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[16])); 

ST_SPHD_HIPERF_1024x32m4_Tlmr_lock_up_latch  latch_SDRO (.CK(!CK_lock_up_latch), .D(D_scff_out[16]), .Q(SDRO_temp));
...
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim SLEEP_MUX (vddmo_int,1'b0,SLEEP_buf,SLEEP_gated);

and (pswsmallma_int,SLEEP_gated,PSWSMALLMA_int);
and (pswlargema_int,SLEEP_gated,PSWLARGEMA_int);
not (pswsmallma_close, pswsmallma_int);
not (pswlargema_close, pswlargema_int);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim switch_pswsmallma (pswsmallma_close,vddma_int,vddmai_small);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim switch_pswlargema (pswlargema_close,vddma_int,vddmai_large);
ST_SPHD_HIPERF_1024x32m4_Tlmr_WANDprim wand_vddmai (vddmai_int,vddmai_small,vddmai_large);

and (pswsmallmp_int,SLEEP_gated,PSWSMALLMP_int);
and (pswlargemp_int,SLEEP_gated,PSWLARGEMP_int);
not (pswsmallmp_close, pswsmallmp_int);
not (pswlargemp_close, pswlargemp_int);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim switch_pswsmallmp (pswsmallmp_close,vddmp_int,vddmpi_small);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim switch_pswlargemp (pswlargemp_close,vddmp_int,vddmpi_large);
ST_SPHD_HIPERF_1024x32m4_Tlmr_WANDprim wand_vddmpi (vddmpi_int,vddmpi_small,vddmpi_large);
...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_INTERFACE (
// functional inputs
A,D,CSN,WEN,CK,SE,TBYPASS,IG,SLEEP,ATP,STDBY,INITN,
...
and (ATP_TBIST, ATP, TBIST);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim CSN_bistmux (ATP_TBIST, CSN, TCSN, CSN_bmux_temp);
buf (CSN_scff_din, CSN_bmux_temp);

ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim WEN_bistmux (ATP_TBIST, WEN, TWEN, WEN_bmux_temp);
...
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_0 (ATP_TBIST, A[0], TA[0], A_bmux[0]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_1 (ATP_TBIST, A[1], TA[1], A_bmux[1]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_2 (ATP_TBIST, A[2], TA[2], A_bmux[2]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_3 (ATP_TBIST, A[3], TA[3], A_bmux[3]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_4 (ATP_TBIST, A[4], TA[4], A_bmux[4]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_5 (ATP_TBIST, A[5], TA[5], A_bmux[5]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_6 (ATP_TBIST, A[6], TA[6], A_bmux[6]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_7 (ATP_TBIST, A[7], TA[7], A_bmux[7]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_8 (ATP_TBIST, A[8], TA[8], A_bmux[8]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim addr_bistmux_9 (ATP_TBIST, A[9], TA[9], A_bmux[9]);

ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_0 (ATP_TBIST,D[0], TED, D_bmux[0]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_1 (ATP_TBIST,D[1], TOD, D_bmux[1]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_2 (ATP_TBIST,D[2], TED, D_bmux[2]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_3 (ATP_TBIST,D[3], TOD, D_bmux[3]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_4 (ATP_TBIST,D[4], TED, D_bmux[4]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_5 (ATP_TBIST,D[5], TOD, D_bmux[5]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_6 (ATP_TBIST,D[6], TED, D_bmux[6]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_7 (ATP_TBIST,D[7], TOD, D_bmux[7]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_8 (ATP_TBIST,D[8], TED, D_bmux[8]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_9 (ATP_TBIST,D[9], TOD, D_bmux[9]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_10 (ATP_TBIST,D[10], TED, D_bmux[10]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_11 (ATP_TBIST,D[11], TOD, D_bmux[11]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_12 (ATP_TBIST,D[12], TED, D_bmux[12]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_13 (ATP_TBIST,D[13], TOD, D_bmux[13]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_14 (ATP_TBIST,D[14], TED, D_bmux[14]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_15 (ATP_TBIST,D[15], TOD, D_bmux[15]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_16 (ATP_TBIST,D[16], TED, D_bmux[16]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_17 (ATP_TBIST,D[17], TOD, D_bmux[17]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_18 (ATP_TBIST,D[18], TED, D_bmux[18]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_19 (ATP_TBIST,D[19], TOD, D_bmux[19]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_20 (ATP_TBIST,D[20], TED, D_bmux[20]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_21 (ATP_TBIST,D[21], TOD, D_bmux[21]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_22 (ATP_TBIST,D[22], TED, D_bmux[22]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_23 (ATP_TBIST,D[23], TOD, D_bmux[23]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_24 (ATP_TBIST,D[24], TED, D_bmux[24]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_25 (ATP_TBIST,D[25], TOD, D_bmux[25]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_26 (ATP_TBIST,D[26], TED, D_bmux[26]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_27 (ATP_TBIST,D[27], TOD, D_bmux[27]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_28 (ATP_TBIST,D[28], TED, D_bmux[28]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_29 (ATP_TBIST,D[29], TOD, D_bmux[29]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_30 (ATP_TBIST,D[30], TED, D_bmux[30]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim data_bistmux_31 (ATP_TBIST,D[31], TOD, D_bmux[31]);
...
// Clock Gating Logic
ST_SPHD_HIPERF_1024x32m4_Tlmr_CGCprim cgc_CK_scff (.EN(shift_or_capt_inst), .CK(CK), .CK_gated(CK_scff));

// Clock for lock-up-latch at the end of scan chains... (scan shift mode)
ST_SPHD_HIPERF_1024x32m4_Tlmr_CGCprim cgc_CK_lkp_latch (.EN(shift_en_inst), .CK(CK), .CK_gated(CK_lock_up_latch));
...
// ----- Clock generation for "rw" block
ST_SPHD_HIPERF_1024x32m4_Tlmr_CGCprim cgc_CK_rw (.EN(MEM_EN_inst), .CK(CK), .CK_gated(CK_rw));
...
// ----- Mem Enable signal -----
ST_SPHD_HIPERF_1024x32m4_Tlmr_DFFprim_blocking dff_mem_en (1'b0, bypass_en, CK_rw, MEM_EN_inst, MEMEN_reg_temp);
and (MEMEN_reg, MEMEN_reg_temp, !bypass_en); // To Avoid 'Z' violations


// ---- bypass enable signal -----
ST_SPHD_HIPERF_1024x32m4_Tlmr_DLATprim dlat_se (1'b0, 1'b0, !CK, SEint, SE_lat);


and (capt_byp_en_inst, GAC, ATP, !SEint, TBYPASSint, !BYP_ENint);
ST_SPHD_HIPERF_1024x32m4_Tlmr_CGCprim cgc_CK_bypass (.EN(capt_byp_en_inst), .CK(CK), .CK_gated(CK_bypass));
...
/*-------------------------------------------------------------------
        Output MUX : Paths on Output 'Q'
           ...
           2) BYPASS path      : From data scff  - D_scff_out
--------------------------------------------------------------------*/
ST_SPHD_HIPERF_1024x32m4_Tlmr_outputmux omux (.Q(Q), .D_scff_out(D_scff_out), .bypass_en(bypass_en), .Q_CORE(Q_CORE), .MEMEN_reg(MEMEN_reg));
...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_outputmux ( Q, D_scff_out, bypass_en, Q_CORE, MEMEN_reg);
...
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_0 (MEMEN_reg, Q_CORE[0], Q[0]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_1 (MEMEN_reg, Q_CORE[1], Q[1]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_2 (MEMEN_reg, Q_CORE[2], Q[2]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_3 (MEMEN_reg, Q_CORE[3], Q[3]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_4 (MEMEN_reg, Q_CORE[4], Q[4]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_5 (MEMEN_reg, Q_CORE[5], Q[5]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_6 (MEMEN_reg, Q_CORE[6], Q[6]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_7 (MEMEN_reg, Q_CORE[7], Q[7]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_8 (MEMEN_reg, Q_CORE[8], Q[8]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_9 (MEMEN_reg, Q_CORE[9], Q[9]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_10 (MEMEN_reg, Q_CORE[10], Q[10]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_11 (MEMEN_reg, Q_CORE[11], Q[11]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_12 (MEMEN_reg, Q_CORE[12], Q[12]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_13 (MEMEN_reg, Q_CORE[13], Q[13]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_14 (MEMEN_reg, Q_CORE[14], Q[14]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_15 (MEMEN_reg, Q_CORE[15], Q[15]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_16 (MEMEN_reg, Q_CORE[16], Q[16]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_17 (MEMEN_reg, Q_CORE[17], Q[17]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_18 (MEMEN_reg, Q_CORE[18], Q[18]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_19 (MEMEN_reg, Q_CORE[19], Q[19]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_20 (MEMEN_reg, Q_CORE[20], Q[20]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_21 (MEMEN_reg, Q_CORE[21], Q[21]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_22 (MEMEN_reg, Q_CORE[22], Q[22]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_23 (MEMEN_reg, Q_CORE[23], Q[23]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_24 (MEMEN_reg, Q_CORE[24], Q[24]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_25 (MEMEN_reg, Q_CORE[25], Q[25]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_26 (MEMEN_reg, Q_CORE[26], Q[26]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_27 (MEMEN_reg, Q_CORE[27], Q[27]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_28 (MEMEN_reg, Q_CORE[28], Q[28]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_29 (MEMEN_reg, Q_CORE[29], Q[29]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_30 (MEMEN_reg, Q_CORE[30], Q[30]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim memory_path_31 (MEMEN_reg, Q_CORE[31], Q[31]);

ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_0 (bypass_en, D_scff_out[0], Q[0]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_1 (bypass_en, D_scff_out[1], Q[1]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_2 (bypass_en, D_scff_out[2], Q[2]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_3 (bypass_en, D_scff_out[3], Q[3]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_4 (bypass_en, D_scff_out[4], Q[4]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_5 (bypass_en, D_scff_out[5], Q[5]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_6 (bypass_en, D_scff_out[6], Q[6]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_7 (bypass_en, D_scff_out[7], Q[7]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_8 (bypass_en, D_scff_out[8], Q[8]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_9 (bypass_en, D_scff_out[9], Q[9]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_10 (bypass_en, D_scff_out[10], Q[10]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_11 (bypass_en, D_scff_out[11], Q[11]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_12 (bypass_en, D_scff_out[12], Q[12]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_13 (bypass_en, D_scff_out[13], Q[13]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_14 (bypass_en, D_scff_out[14], Q[14]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_15 (bypass_en, D_scff_out[15], Q[15]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_16 (bypass_en, D_scff_out[16], Q[16]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_17 (bypass_en, D_scff_out[17], Q[17]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_18 (bypass_en, D_scff_out[18], Q[18]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_19 (bypass_en, D_scff_out[19], Q[19]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_20 (bypass_en, D_scff_out[20], Q[20]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_21 (bypass_en, D_scff_out[21], Q[21]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_22 (bypass_en, D_scff_out[22], Q[22]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_23 (bypass_en, D_scff_out[23], Q[23]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_24 (bypass_en, D_scff_out[24], Q[24]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_25 (bypass_en, D_scff_out[25], Q[25]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_26 (bypass_en, D_scff_out[26], Q[26]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_27 (bypass_en, D_scff_out[27], Q[27]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_28 (bypass_en, D_scff_out[28], Q[28]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_29 (bypass_en, D_scff_out[29], Q[29]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_30 (bypass_en, D_scff_out[30], Q[30]);
ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim bypass_path_31 (bypass_en, D_scff_out[31], Q[31]);
...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_WANDprim (out,in1,in2);
input in1,in2;
output out;
...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim (SEL, A, B, Z);
input SEL, A, B;
output Z;
...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_CGCprim (EN, CK, CK_gated);
input EN, CK;
output reg CK_gated;
reg last_CK;
...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_lock_up_latch (CK, D, Q);
input CK,D;
output Q;

ST_SPHD_HIPERF_1024x32m4_Tlmr_DLATprim dlat_lockup (1'b0, 1'b0, CK, D, Q);

endmodule

module ST_SPHD_HIPERF_1024x32m4_Tlmr_SCFF (D,TI,TE,CP,Q);
input D,TI,TE,CP;
output Q;

ST_SPHD_HIPERF_1024x32m4_Tlmr_MUXprim mux_in_scff (TE, D, TI, temp);
ST_SPHD_HIPERF_1024x32m4_Tlmr_DFFprim dff_in_scff (1'b0, 1'b0, CP, temp, Q);

endmodule

module ST_SPHD_HIPERF_1024x32m4_Tlmr_DFFprim (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg Qtemp, last_CK;
...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_DFFprim_blocking (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg last_CK;
...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_DLATprim (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg Qprev;
...
module ST_SPHD_HIPERF_1024x32m4_Tlmr_SWprim (control,in,out);
output out;
input control,in;
...
/*------------------------------------------------------------------------------------------
            ST_SPHD_HIPERF_3072x32m8_Tlmr model for Verilog 
-------------------------------------------------------------------------------------------*/
...
ST_SPHD_HIPERF_3072x32m8_Tlmr_INTERFACE IO (
...
ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_0  (.D(ctrl_scff_in[0]), .TI(SCTRLI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[0]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_1 (.D(ctrl_scff_in[1]), .TI(ctrl_scff_out[0]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[1]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_2 (.D(ctrl_scff_in[2]), .TI(ctrl_scff_out[1]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[2]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_3 (.D(ctrl_scff_in[3]), .TI(ctrl_scff_out[2]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[3]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_4 (.D(ctrl_scff_in[4]), .TI(ctrl_scff_out[3]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[4]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_5 (.D(ctrl_scff_in[5]), .TI(ctrl_scff_out[4]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[5]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_6 (.D(ctrl_scff_in[6]), .TI(ctrl_scff_out[5]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[6]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_7 (.D(ctrl_scff_in[7]), .TI(ctrl_scff_out[6]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[7]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_8 (.D(ctrl_scff_in[8]), .TI(ctrl_scff_out[7]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[8]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_9 (.D(ctrl_scff_in[9]), .TI(ctrl_scff_out[8]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[9]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_10 (.D(ctrl_scff_in[10]), .TI(ctrl_scff_out[9]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[10]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_11 (.D(ctrl_scff_in[11]), .TI(ctrl_scff_out[10]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[11]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_12 (.D(ctrl_scff_in[12]), .TI(ctrl_scff_out[11]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[12]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_13 (.D(ctrl_scff_in[13]), .TI(ctrl_scff_out[12]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[13]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_14 (.D(ctrl_scff_in[14]), .TI(ctrl_scff_out[13]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[14]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_15 (.D(ctrl_scff_in[15]), .TI(ctrl_scff_out[14]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[15]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_ctrl_16 (.D(ctrl_scff_in[16]), .TI(ctrl_scff_out[15]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[16]));

ST_SPHD_HIPERF_3072x32m8_Tlmr_lock_up_latch  latch_SCTRLO (.CK(!CK_lock_up_latch), .D(ctrl_scff_out[16]), .Q(SCTRLO_temp));
...
ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_0 (.D(D_bmux[15]), .TI(SDLI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[15])); 


 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_1 (.D(D_bmux[14]),  .TI(D_scff_out[15]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[14]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_2 (.D(D_bmux[13]),  .TI(D_scff_out[14]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[13]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_3 (.D(D_bmux[12]),  .TI(D_scff_out[13]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[12]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_4 (.D(D_bmux[11]),  .TI(D_scff_out[12]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[11]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_5 (.D(D_bmux[10]),  .TI(D_scff_out[11]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[10]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_6 (.D(D_bmux[9]),  .TI(D_scff_out[10]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[9]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_7 (.D(D_bmux[8]),  .TI(D_scff_out[9]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[8]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_8 (.D(D_bmux[7]),  .TI(D_scff_out[8]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[7]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_9 (.D(D_bmux[6]),  .TI(D_scff_out[7]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[6]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_10 (.D(D_bmux[5]),  .TI(D_scff_out[6]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[5]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_11 (.D(D_bmux[4]),  .TI(D_scff_out[5]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[4]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_12 (.D(D_bmux[3]),  .TI(D_scff_out[4]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[3]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_13 (.D(D_bmux[2]),  .TI(D_scff_out[3]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[2]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_14 (.D(D_bmux[1]),  .TI(D_scff_out[2]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[1]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_left_15 (.D(D_bmux[0]),  .TI(D_scff_out[1]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[0])); 

ST_SPHD_HIPERF_3072x32m8_Tlmr_lock_up_latch  latch_SDLO (.CK(!CK_lock_up_latch), .D(D_scff_out[0]), .Q(SDLO_temp)); 
...
ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_0 (.D(D_bmux[31]), .TI(SDRI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[31])); 

 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_1 (.D(D_bmux[30]),  .TI(D_scff_out[31]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[30]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_2 (.D(D_bmux[29]),  .TI(D_scff_out[30]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[29]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_3 (.D(D_bmux[28]),  .TI(D_scff_out[29]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[28]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_4 (.D(D_bmux[27]),  .TI(D_scff_out[28]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[27]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_5 (.D(D_bmux[26]),  .TI(D_scff_out[27]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[26]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_6 (.D(D_bmux[25]),  .TI(D_scff_out[26]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[25]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_7 (.D(D_bmux[24]),  .TI(D_scff_out[25]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[24]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_8 (.D(D_bmux[23]),  .TI(D_scff_out[24]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[23]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_9 (.D(D_bmux[22]),  .TI(D_scff_out[23]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[22]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_10 (.D(D_bmux[21]),  .TI(D_scff_out[22]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[21]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_11 (.D(D_bmux[20]),  .TI(D_scff_out[21]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[20]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_12 (.D(D_bmux[19]),  .TI(D_scff_out[20]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[19]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_13 (.D(D_bmux[18]),  .TI(D_scff_out[19]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[18]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_14 (.D(D_bmux[17]),  .TI(D_scff_out[18]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[17]));
 ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF scff_data_right_15 (.D(D_bmux[16]),  .TI(D_scff_out[17]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[16])); 

ST_SPHD_HIPERF_3072x32m8_Tlmr_lock_up_latch  latch_SDRO (.CK(!CK_lock_up_latch), .D(D_scff_out[16]), .Q(SDRO_temp));
...
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim SLEEP_MUX (vddmo_int,1'b0,SLEEP_buf,SLEEP_gated);

and (pswsmallma_int,SLEEP_gated,PSWSMALLMA_int);
and (pswlargema_int,SLEEP_gated,PSWLARGEMA_int);
not (pswsmallma_close, pswsmallma_int);
not (pswlargema_close, pswlargema_int);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim switch_pswsmallma (pswsmallma_close,vddma_int,vddmai_small);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim switch_pswlargema (pswlargema_close,vddma_int,vddmai_large);
ST_SPHD_HIPERF_3072x32m8_Tlmr_WANDprim wand_vddmai (vddmai_int,vddmai_small,vddmai_large);

and (pswsmallmp_int,SLEEP_gated,PSWSMALLMP_int);
and (pswlargemp_int,SLEEP_gated,PSWLARGEMP_int);
not (pswsmallmp_close, pswsmallmp_int);
not (pswlargemp_close, pswlargemp_int);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim switch_pswsmallmp (pswsmallmp_close,vddmp_int,vddmpi_small);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim switch_pswlargemp (pswlargemp_close,vddmp_int,vddmpi_large);
ST_SPHD_HIPERF_3072x32m8_Tlmr_WANDprim wand_vddmpi (vddmpi_int,vddmpi_small,vddmpi_large);
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_INTERFACE (
// functional inputs
A,D,CSN,WEN,CK,SE,TBYPASS,IG,SLEEP,ATP,STDBY,INITN,
...
and (ATP_TBIST, ATP, TBIST);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim CSN_bistmux (ATP_TBIST, CSN, TCSN, CSN_bmux_temp);
buf (CSN_scff_din, CSN_bmux_temp);

ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim WEN_bistmux (ATP_TBIST, WEN, TWEN, WEN_bmux_temp);
...
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_0 (ATP_TBIST, A[0], TA[0], A_bmux[0]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_1 (ATP_TBIST, A[1], TA[1], A_bmux[1]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_2 (ATP_TBIST, A[2], TA[2], A_bmux[2]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_3 (ATP_TBIST, A[3], TA[3], A_bmux[3]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_4 (ATP_TBIST, A[4], TA[4], A_bmux[4]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_5 (ATP_TBIST, A[5], TA[5], A_bmux[5]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_6 (ATP_TBIST, A[6], TA[6], A_bmux[6]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_7 (ATP_TBIST, A[7], TA[7], A_bmux[7]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_8 (ATP_TBIST, A[8], TA[8], A_bmux[8]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_9 (ATP_TBIST, A[9], TA[9], A_bmux[9]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_10 (ATP_TBIST, A[10], TA[10], A_bmux[10]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim addr_bistmux_11 (ATP_TBIST, A[11], TA[11], A_bmux[11]);

ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_0 (ATP_TBIST,D[0], TED, D_bmux[0]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_1 (ATP_TBIST,D[1], TOD, D_bmux[1]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_2 (ATP_TBIST,D[2], TED, D_bmux[2]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_3 (ATP_TBIST,D[3], TOD, D_bmux[3]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_4 (ATP_TBIST,D[4], TED, D_bmux[4]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_5 (ATP_TBIST,D[5], TOD, D_bmux[5]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_6 (ATP_TBIST,D[6], TED, D_bmux[6]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_7 (ATP_TBIST,D[7], TOD, D_bmux[7]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_8 (ATP_TBIST,D[8], TED, D_bmux[8]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_9 (ATP_TBIST,D[9], TOD, D_bmux[9]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_10 (ATP_TBIST,D[10], TED, D_bmux[10]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_11 (ATP_TBIST,D[11], TOD, D_bmux[11]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_12 (ATP_TBIST,D[12], TED, D_bmux[12]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_13 (ATP_TBIST,D[13], TOD, D_bmux[13]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_14 (ATP_TBIST,D[14], TED, D_bmux[14]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_15 (ATP_TBIST,D[15], TOD, D_bmux[15]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_16 (ATP_TBIST,D[16], TED, D_bmux[16]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_17 (ATP_TBIST,D[17], TOD, D_bmux[17]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_18 (ATP_TBIST,D[18], TED, D_bmux[18]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_19 (ATP_TBIST,D[19], TOD, D_bmux[19]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_20 (ATP_TBIST,D[20], TED, D_bmux[20]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_21 (ATP_TBIST,D[21], TOD, D_bmux[21]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_22 (ATP_TBIST,D[22], TED, D_bmux[22]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_23 (ATP_TBIST,D[23], TOD, D_bmux[23]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_24 (ATP_TBIST,D[24], TED, D_bmux[24]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_25 (ATP_TBIST,D[25], TOD, D_bmux[25]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_26 (ATP_TBIST,D[26], TED, D_bmux[26]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_27 (ATP_TBIST,D[27], TOD, D_bmux[27]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_28 (ATP_TBIST,D[28], TED, D_bmux[28]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_29 (ATP_TBIST,D[29], TOD, D_bmux[29]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_30 (ATP_TBIST,D[30], TED, D_bmux[30]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim data_bistmux_31 (ATP_TBIST,D[31], TOD, D_bmux[31]);
...
// Clock Gating Logic
ST_SPHD_HIPERF_3072x32m8_Tlmr_CGCprim cgc_CK_scff (.EN(shift_or_capt_inst), .CK(CK), .CK_gated(CK_scff));

// Clock for lock-up-latch at the end of scan chains... (scan shift mode)
ST_SPHD_HIPERF_3072x32m8_Tlmr_CGCprim cgc_CK_lkp_latch (.EN(shift_en_inst), .CK(CK), .CK_gated(CK_lock_up_latch));
...
// ----- Clock generation for "rw" block
ST_SPHD_HIPERF_3072x32m8_Tlmr_CGCprim cgc_CK_rw (.EN(MEM_EN_inst), .CK(CK), .CK_gated(CK_rw));
...
// ----- Mem Enable signal -----
ST_SPHD_HIPERF_3072x32m8_Tlmr_DFFprim_blocking dff_mem_en (1'b0, bypass_en, CK_rw, MEM_EN_inst, MEMEN_reg_temp);
and (MEMEN_reg, MEMEN_reg_temp, !bypass_en); // To Avoid 'Z' violations


// ---- bypass enable signal -----
ST_SPHD_HIPERF_3072x32m8_Tlmr_DLATprim dlat_se (1'b0, 1'b0, !CK, SEint, SE_lat);


and (capt_byp_en_inst, GAC, ATP, !SEint, TBYPASSint, !BYP_ENint);
ST_SPHD_HIPERF_3072x32m8_Tlmr_CGCprim cgc_CK_bypass (.EN(capt_byp_en_inst), .CK(CK), .CK_gated(CK_bypass));
...
/*-------------------------------------------------------------------
        Output MUX : Paths on Output 'Q'
           ...
           2) BYPASS path      : From data scff  - D_scff_out
--------------------------------------------------------------------*/
ST_SPHD_HIPERF_3072x32m8_Tlmr_outputmux omux (.Q(Q), .D_scff_out(D_scff_out), .bypass_en(bypass_en), .Q_CORE(Q_CORE), .MEMEN_reg(MEMEN_reg));
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_outputmux ( Q, D_scff_out, bypass_en, Q_CORE, MEMEN_reg);
...
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_0 (MEMEN_reg, Q_CORE[0], Q[0]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_1 (MEMEN_reg, Q_CORE[1], Q[1]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_2 (MEMEN_reg, Q_CORE[2], Q[2]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_3 (MEMEN_reg, Q_CORE[3], Q[3]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_4 (MEMEN_reg, Q_CORE[4], Q[4]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_5 (MEMEN_reg, Q_CORE[5], Q[5]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_6 (MEMEN_reg, Q_CORE[6], Q[6]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_7 (MEMEN_reg, Q_CORE[7], Q[7]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_8 (MEMEN_reg, Q_CORE[8], Q[8]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_9 (MEMEN_reg, Q_CORE[9], Q[9]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_10 (MEMEN_reg, Q_CORE[10], Q[10]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_11 (MEMEN_reg, Q_CORE[11], Q[11]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_12 (MEMEN_reg, Q_CORE[12], Q[12]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_13 (MEMEN_reg, Q_CORE[13], Q[13]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_14 (MEMEN_reg, Q_CORE[14], Q[14]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_15 (MEMEN_reg, Q_CORE[15], Q[15]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_16 (MEMEN_reg, Q_CORE[16], Q[16]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_17 (MEMEN_reg, Q_CORE[17], Q[17]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_18 (MEMEN_reg, Q_CORE[18], Q[18]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_19 (MEMEN_reg, Q_CORE[19], Q[19]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_20 (MEMEN_reg, Q_CORE[20], Q[20]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_21 (MEMEN_reg, Q_CORE[21], Q[21]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_22 (MEMEN_reg, Q_CORE[22], Q[22]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_23 (MEMEN_reg, Q_CORE[23], Q[23]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_24 (MEMEN_reg, Q_CORE[24], Q[24]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_25 (MEMEN_reg, Q_CORE[25], Q[25]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_26 (MEMEN_reg, Q_CORE[26], Q[26]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_27 (MEMEN_reg, Q_CORE[27], Q[27]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_28 (MEMEN_reg, Q_CORE[28], Q[28]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_29 (MEMEN_reg, Q_CORE[29], Q[29]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_30 (MEMEN_reg, Q_CORE[30], Q[30]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim memory_path_31 (MEMEN_reg, Q_CORE[31], Q[31]);

ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_0 (bypass_en, D_scff_out[0], Q[0]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_1 (bypass_en, D_scff_out[1], Q[1]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_2 (bypass_en, D_scff_out[2], Q[2]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_3 (bypass_en, D_scff_out[3], Q[3]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_4 (bypass_en, D_scff_out[4], Q[4]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_5 (bypass_en, D_scff_out[5], Q[5]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_6 (bypass_en, D_scff_out[6], Q[6]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_7 (bypass_en, D_scff_out[7], Q[7]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_8 (bypass_en, D_scff_out[8], Q[8]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_9 (bypass_en, D_scff_out[9], Q[9]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_10 (bypass_en, D_scff_out[10], Q[10]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_11 (bypass_en, D_scff_out[11], Q[11]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_12 (bypass_en, D_scff_out[12], Q[12]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_13 (bypass_en, D_scff_out[13], Q[13]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_14 (bypass_en, D_scff_out[14], Q[14]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_15 (bypass_en, D_scff_out[15], Q[15]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_16 (bypass_en, D_scff_out[16], Q[16]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_17 (bypass_en, D_scff_out[17], Q[17]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_18 (bypass_en, D_scff_out[18], Q[18]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_19 (bypass_en, D_scff_out[19], Q[19]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_20 (bypass_en, D_scff_out[20], Q[20]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_21 (bypass_en, D_scff_out[21], Q[21]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_22 (bypass_en, D_scff_out[22], Q[22]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_23 (bypass_en, D_scff_out[23], Q[23]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_24 (bypass_en, D_scff_out[24], Q[24]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_25 (bypass_en, D_scff_out[25], Q[25]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_26 (bypass_en, D_scff_out[26], Q[26]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_27 (bypass_en, D_scff_out[27], Q[27]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_28 (bypass_en, D_scff_out[28], Q[28]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_29 (bypass_en, D_scff_out[29], Q[29]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_30 (bypass_en, D_scff_out[30], Q[30]);
ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim bypass_path_31 (bypass_en, D_scff_out[31], Q[31]);
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_WANDprim (out,in1,in2);
input in1,in2;
output out;
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim (SEL, A, B, Z);
input SEL, A, B;
output Z;
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_CGCprim (EN, CK, CK_gated);
input EN, CK;
output reg CK_gated;
reg last_CK;
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_lock_up_latch (CK, D, Q);
input CK,D;
output Q;

ST_SPHD_HIPERF_3072x32m8_Tlmr_DLATprim dlat_lockup (1'b0, 1'b0, CK, D, Q);

endmodule

module ST_SPHD_HIPERF_3072x32m8_Tlmr_SCFF (D,TI,TE,CP,Q);
input D,TI,TE,CP;
output Q;

ST_SPHD_HIPERF_3072x32m8_Tlmr_MUXprim mux_in_scff (TE, D, TI, temp);
ST_SPHD_HIPERF_3072x32m8_Tlmr_DFFprim dff_in_scff (1'b0, 1'b0, CP, temp, Q);

endmodule

module ST_SPHD_HIPERF_3072x32m8_Tlmr_DFFprim (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg Qtemp, last_CK;
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_DFFprim_blocking (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg last_CK;
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_DLATprim (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg Qprev;
...
module ST_SPHD_HIPERF_3072x32m8_Tlmr_SWprim (control,in,out);
output out;
input control,in;
...
/*------------------------------------------------------------------------------------------
            ST_SPHD_HIPERF_2048x32m8_Tlmr model for Verilog 
-------------------------------------------------------------------------------------------*/
...
ST_SPHD_HIPERF_2048x32m8_Tlmr_INTERFACE IO (
...
ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_0  (.D(ctrl_scff_in[0]), .TI(SCTRLI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[0]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_1 (.D(ctrl_scff_in[1]), .TI(ctrl_scff_out[0]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[1]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_2 (.D(ctrl_scff_in[2]), .TI(ctrl_scff_out[1]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[2]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_3 (.D(ctrl_scff_in[3]), .TI(ctrl_scff_out[2]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[3]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_4 (.D(ctrl_scff_in[4]), .TI(ctrl_scff_out[3]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[4]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_5 (.D(ctrl_scff_in[5]), .TI(ctrl_scff_out[4]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[5]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_6 (.D(ctrl_scff_in[6]), .TI(ctrl_scff_out[5]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[6]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_7 (.D(ctrl_scff_in[7]), .TI(ctrl_scff_out[6]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[7]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_8 (.D(ctrl_scff_in[8]), .TI(ctrl_scff_out[7]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[8]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_9 (.D(ctrl_scff_in[9]), .TI(ctrl_scff_out[8]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[9]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_10 (.D(ctrl_scff_in[10]), .TI(ctrl_scff_out[9]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[10]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_11 (.D(ctrl_scff_in[11]), .TI(ctrl_scff_out[10]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[11]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_12 (.D(ctrl_scff_in[12]), .TI(ctrl_scff_out[11]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[12]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_13 (.D(ctrl_scff_in[13]), .TI(ctrl_scff_out[12]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[13]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_14 (.D(ctrl_scff_in[14]), .TI(ctrl_scff_out[13]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[14]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_15 (.D(ctrl_scff_in[15]), .TI(ctrl_scff_out[14]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[15]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_ctrl_16 (.D(ctrl_scff_in[16]), .TI(ctrl_scff_out[15]), .TE(shift_en_inst), .CP(CK_scff), .Q(ctrl_scff_out[16]));

ST_SPHD_HIPERF_2048x32m8_Tlmr_lock_up_latch  latch_SCTRLO (.CK(!CK_lock_up_latch), .D(ctrl_scff_out[16]), .Q(SCTRLO_temp));
...
ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_0 (.D(D_bmux[15]), .TI(SDLI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[15])); 


 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_1 (.D(D_bmux[14]),  .TI(D_scff_out[15]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[14]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_2 (.D(D_bmux[13]),  .TI(D_scff_out[14]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[13]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_3 (.D(D_bmux[12]),  .TI(D_scff_out[13]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[12]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_4 (.D(D_bmux[11]),  .TI(D_scff_out[12]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[11]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_5 (.D(D_bmux[10]),  .TI(D_scff_out[11]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[10]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_6 (.D(D_bmux[9]),  .TI(D_scff_out[10]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[9]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_7 (.D(D_bmux[8]),  .TI(D_scff_out[9]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[8]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_8 (.D(D_bmux[7]),  .TI(D_scff_out[8]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[7]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_9 (.D(D_bmux[6]),  .TI(D_scff_out[7]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[6]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_10 (.D(D_bmux[5]),  .TI(D_scff_out[6]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[5]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_11 (.D(D_bmux[4]),  .TI(D_scff_out[5]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[4]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_12 (.D(D_bmux[3]),  .TI(D_scff_out[4]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[3]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_13 (.D(D_bmux[2]),  .TI(D_scff_out[3]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[2]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_14 (.D(D_bmux[1]),  .TI(D_scff_out[2]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[1]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_left_15 (.D(D_bmux[0]),  .TI(D_scff_out[1]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[0])); 

ST_SPHD_HIPERF_2048x32m8_Tlmr_lock_up_latch  latch_SDLO (.CK(!CK_lock_up_latch), .D(D_scff_out[0]), .Q(SDLO_temp)); 
...
ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_0 (.D(D_bmux[31]), .TI(SDRI_buf), .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[31])); 

 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_1 (.D(D_bmux[30]),  .TI(D_scff_out[31]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[30]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_2 (.D(D_bmux[29]),  .TI(D_scff_out[30]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[29]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_3 (.D(D_bmux[28]),  .TI(D_scff_out[29]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[28]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_4 (.D(D_bmux[27]),  .TI(D_scff_out[28]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[27]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_5 (.D(D_bmux[26]),  .TI(D_scff_out[27]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[26]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_6 (.D(D_bmux[25]),  .TI(D_scff_out[26]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[25]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_7 (.D(D_bmux[24]),  .TI(D_scff_out[25]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[24]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_8 (.D(D_bmux[23]),  .TI(D_scff_out[24]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[23]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_9 (.D(D_bmux[22]),  .TI(D_scff_out[23]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[22]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_10 (.D(D_bmux[21]),  .TI(D_scff_out[22]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[21]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_11 (.D(D_bmux[20]),  .TI(D_scff_out[21]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[20]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_12 (.D(D_bmux[19]),  .TI(D_scff_out[20]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[19]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_13 (.D(D_bmux[18]),  .TI(D_scff_out[19]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[18]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_14 (.D(D_bmux[17]),  .TI(D_scff_out[18]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[17]));
 ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF scff_data_right_15 (.D(D_bmux[16]),  .TI(D_scff_out[17]) , .TE(shift_en_inst), .CP(CK_scff), .Q(D_scff_out[16])); 

ST_SPHD_HIPERF_2048x32m8_Tlmr_lock_up_latch  latch_SDRO (.CK(!CK_lock_up_latch), .D(D_scff_out[16]), .Q(SDRO_temp));
...
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim SLEEP_MUX (vddmo_int,1'b0,SLEEP_buf,SLEEP_gated);

and (pswsmallma_int,SLEEP_gated,PSWSMALLMA_int);
and (pswlargema_int,SLEEP_gated,PSWLARGEMA_int);
not (pswsmallma_close, pswsmallma_int);
not (pswlargema_close, pswlargema_int);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim switch_pswsmallma (pswsmallma_close,vddma_int,vddmai_small);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim switch_pswlargema (pswlargema_close,vddma_int,vddmai_large);
ST_SPHD_HIPERF_2048x32m8_Tlmr_WANDprim wand_vddmai (vddmai_int,vddmai_small,vddmai_large);

and (pswsmallmp_int,SLEEP_gated,PSWSMALLMP_int);
and (pswlargemp_int,SLEEP_gated,PSWLARGEMP_int);
not (pswsmallmp_close, pswsmallmp_int);
not (pswlargemp_close, pswlargemp_int);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim switch_pswsmallmp (pswsmallmp_close,vddmp_int,vddmpi_small);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim switch_pswlargemp (pswlargemp_close,vddmp_int,vddmpi_large);
ST_SPHD_HIPERF_2048x32m8_Tlmr_WANDprim wand_vddmpi (vddmpi_int,vddmpi_small,vddmpi_large);
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_INTERFACE (
// functional inputs
A,D,CSN,WEN,CK,SE,TBYPASS,IG,SLEEP,ATP,STDBY,INITN,
...
and (ATP_TBIST, ATP, TBIST);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim CSN_bistmux (ATP_TBIST, CSN, TCSN, CSN_bmux_temp);
buf (CSN_scff_din, CSN_bmux_temp);

ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim WEN_bistmux (ATP_TBIST, WEN, TWEN, WEN_bmux_temp);
...
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_0 (ATP_TBIST, A[0], TA[0], A_bmux[0]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_1 (ATP_TBIST, A[1], TA[1], A_bmux[1]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_2 (ATP_TBIST, A[2], TA[2], A_bmux[2]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_3 (ATP_TBIST, A[3], TA[3], A_bmux[3]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_4 (ATP_TBIST, A[4], TA[4], A_bmux[4]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_5 (ATP_TBIST, A[5], TA[5], A_bmux[5]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_6 (ATP_TBIST, A[6], TA[6], A_bmux[6]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_7 (ATP_TBIST, A[7], TA[7], A_bmux[7]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_8 (ATP_TBIST, A[8], TA[8], A_bmux[8]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_9 (ATP_TBIST, A[9], TA[9], A_bmux[9]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim addr_bistmux_10 (ATP_TBIST, A[10], TA[10], A_bmux[10]);

ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_0 (ATP_TBIST,D[0], TED, D_bmux[0]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_1 (ATP_TBIST,D[1], TOD, D_bmux[1]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_2 (ATP_TBIST,D[2], TED, D_bmux[2]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_3 (ATP_TBIST,D[3], TOD, D_bmux[3]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_4 (ATP_TBIST,D[4], TED, D_bmux[4]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_5 (ATP_TBIST,D[5], TOD, D_bmux[5]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_6 (ATP_TBIST,D[6], TED, D_bmux[6]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_7 (ATP_TBIST,D[7], TOD, D_bmux[7]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_8 (ATP_TBIST,D[8], TED, D_bmux[8]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_9 (ATP_TBIST,D[9], TOD, D_bmux[9]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_10 (ATP_TBIST,D[10], TED, D_bmux[10]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_11 (ATP_TBIST,D[11], TOD, D_bmux[11]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_12 (ATP_TBIST,D[12], TED, D_bmux[12]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_13 (ATP_TBIST,D[13], TOD, D_bmux[13]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_14 (ATP_TBIST,D[14], TED, D_bmux[14]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_15 (ATP_TBIST,D[15], TOD, D_bmux[15]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_16 (ATP_TBIST,D[16], TED, D_bmux[16]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_17 (ATP_TBIST,D[17], TOD, D_bmux[17]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_18 (ATP_TBIST,D[18], TED, D_bmux[18]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_19 (ATP_TBIST,D[19], TOD, D_bmux[19]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_20 (ATP_TBIST,D[20], TED, D_bmux[20]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_21 (ATP_TBIST,D[21], TOD, D_bmux[21]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_22 (ATP_TBIST,D[22], TED, D_bmux[22]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_23 (ATP_TBIST,D[23], TOD, D_bmux[23]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_24 (ATP_TBIST,D[24], TED, D_bmux[24]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_25 (ATP_TBIST,D[25], TOD, D_bmux[25]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_26 (ATP_TBIST,D[26], TED, D_bmux[26]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_27 (ATP_TBIST,D[27], TOD, D_bmux[27]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_28 (ATP_TBIST,D[28], TED, D_bmux[28]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_29 (ATP_TBIST,D[29], TOD, D_bmux[29]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_30 (ATP_TBIST,D[30], TED, D_bmux[30]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim data_bistmux_31 (ATP_TBIST,D[31], TOD, D_bmux[31]);
...
// Clock Gating Logic
ST_SPHD_HIPERF_2048x32m8_Tlmr_CGCprim cgc_CK_scff (.EN(shift_or_capt_inst), .CK(CK), .CK_gated(CK_scff));

// Clock for lock-up-latch at the end of scan chains... (scan shift mode)
ST_SPHD_HIPERF_2048x32m8_Tlmr_CGCprim cgc_CK_lkp_latch (.EN(shift_en_inst), .CK(CK), .CK_gated(CK_lock_up_latch));
...
// ----- Clock generation for "rw" block
ST_SPHD_HIPERF_2048x32m8_Tlmr_CGCprim cgc_CK_rw (.EN(MEM_EN_inst), .CK(CK), .CK_gated(CK_rw));
...
// ----- Mem Enable signal -----
ST_SPHD_HIPERF_2048x32m8_Tlmr_DFFprim_blocking dff_mem_en (1'b0, bypass_en, CK_rw, MEM_EN_inst, MEMEN_reg_temp);
and (MEMEN_reg, MEMEN_reg_temp, !bypass_en); // To Avoid 'Z' violations


// ---- bypass enable signal -----
ST_SPHD_HIPERF_2048x32m8_Tlmr_DLATprim dlat_se (1'b0, 1'b0, !CK, SEint, SE_lat);


and (capt_byp_en_inst, GAC, ATP, !SEint, TBYPASSint, !BYP_ENint);
ST_SPHD_HIPERF_2048x32m8_Tlmr_CGCprim cgc_CK_bypass (.EN(capt_byp_en_inst), .CK(CK), .CK_gated(CK_bypass));
...
/*-------------------------------------------------------------------
        Output MUX : Paths on Output 'Q'
           ...
           2) BYPASS path      : From data scff  - D_scff_out
--------------------------------------------------------------------*/
ST_SPHD_HIPERF_2048x32m8_Tlmr_outputmux omux (.Q(Q), .D_scff_out(D_scff_out), .bypass_en(bypass_en), .Q_CORE(Q_CORE), .MEMEN_reg(MEMEN_reg));
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_outputmux ( Q, D_scff_out, bypass_en, Q_CORE, MEMEN_reg);
...
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_0 (MEMEN_reg, Q_CORE[0], Q[0]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_1 (MEMEN_reg, Q_CORE[1], Q[1]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_2 (MEMEN_reg, Q_CORE[2], Q[2]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_3 (MEMEN_reg, Q_CORE[3], Q[3]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_4 (MEMEN_reg, Q_CORE[4], Q[4]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_5 (MEMEN_reg, Q_CORE[5], Q[5]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_6 (MEMEN_reg, Q_CORE[6], Q[6]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_7 (MEMEN_reg, Q_CORE[7], Q[7]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_8 (MEMEN_reg, Q_CORE[8], Q[8]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_9 (MEMEN_reg, Q_CORE[9], Q[9]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_10 (MEMEN_reg, Q_CORE[10], Q[10]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_11 (MEMEN_reg, Q_CORE[11], Q[11]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_12 (MEMEN_reg, Q_CORE[12], Q[12]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_13 (MEMEN_reg, Q_CORE[13], Q[13]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_14 (MEMEN_reg, Q_CORE[14], Q[14]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_15 (MEMEN_reg, Q_CORE[15], Q[15]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_16 (MEMEN_reg, Q_CORE[16], Q[16]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_17 (MEMEN_reg, Q_CORE[17], Q[17]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_18 (MEMEN_reg, Q_CORE[18], Q[18]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_19 (MEMEN_reg, Q_CORE[19], Q[19]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_20 (MEMEN_reg, Q_CORE[20], Q[20]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_21 (MEMEN_reg, Q_CORE[21], Q[21]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_22 (MEMEN_reg, Q_CORE[22], Q[22]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_23 (MEMEN_reg, Q_CORE[23], Q[23]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_24 (MEMEN_reg, Q_CORE[24], Q[24]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_25 (MEMEN_reg, Q_CORE[25], Q[25]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_26 (MEMEN_reg, Q_CORE[26], Q[26]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_27 (MEMEN_reg, Q_CORE[27], Q[27]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_28 (MEMEN_reg, Q_CORE[28], Q[28]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_29 (MEMEN_reg, Q_CORE[29], Q[29]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_30 (MEMEN_reg, Q_CORE[30], Q[30]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim memory_path_31 (MEMEN_reg, Q_CORE[31], Q[31]);

ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_0 (bypass_en, D_scff_out[0], Q[0]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_1 (bypass_en, D_scff_out[1], Q[1]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_2 (bypass_en, D_scff_out[2], Q[2]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_3 (bypass_en, D_scff_out[3], Q[3]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_4 (bypass_en, D_scff_out[4], Q[4]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_5 (bypass_en, D_scff_out[5], Q[5]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_6 (bypass_en, D_scff_out[6], Q[6]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_7 (bypass_en, D_scff_out[7], Q[7]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_8 (bypass_en, D_scff_out[8], Q[8]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_9 (bypass_en, D_scff_out[9], Q[9]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_10 (bypass_en, D_scff_out[10], Q[10]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_11 (bypass_en, D_scff_out[11], Q[11]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_12 (bypass_en, D_scff_out[12], Q[12]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_13 (bypass_en, D_scff_out[13], Q[13]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_14 (bypass_en, D_scff_out[14], Q[14]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_15 (bypass_en, D_scff_out[15], Q[15]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_16 (bypass_en, D_scff_out[16], Q[16]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_17 (bypass_en, D_scff_out[17], Q[17]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_18 (bypass_en, D_scff_out[18], Q[18]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_19 (bypass_en, D_scff_out[19], Q[19]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_20 (bypass_en, D_scff_out[20], Q[20]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_21 (bypass_en, D_scff_out[21], Q[21]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_22 (bypass_en, D_scff_out[22], Q[22]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_23 (bypass_en, D_scff_out[23], Q[23]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_24 (bypass_en, D_scff_out[24], Q[24]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_25 (bypass_en, D_scff_out[25], Q[25]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_26 (bypass_en, D_scff_out[26], Q[26]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_27 (bypass_en, D_scff_out[27], Q[27]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_28 (bypass_en, D_scff_out[28], Q[28]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_29 (bypass_en, D_scff_out[29], Q[29]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_30 (bypass_en, D_scff_out[30], Q[30]);
ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim bypass_path_31 (bypass_en, D_scff_out[31], Q[31]);
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_WANDprim (out,in1,in2);
input in1,in2;
output out;
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim (SEL, A, B, Z);
input SEL, A, B;
output Z;
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_CGCprim (EN, CK, CK_gated);
input EN, CK;
output reg CK_gated;
reg last_CK;
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_lock_up_latch (CK, D, Q);
input CK,D;
output Q;

ST_SPHD_HIPERF_2048x32m8_Tlmr_DLATprim dlat_lockup (1'b0, 1'b0, CK, D, Q);

endmodule

module ST_SPHD_HIPERF_2048x32m8_Tlmr_SCFF (D,TI,TE,CP,Q);
input D,TI,TE,CP;
output Q;

ST_SPHD_HIPERF_2048x32m8_Tlmr_MUXprim mux_in_scff (TE, D, TI, temp);
ST_SPHD_HIPERF_2048x32m8_Tlmr_DFFprim dff_in_scff (1'b0, 1'b0, CP, temp, Q);

endmodule

module ST_SPHD_HIPERF_2048x32m8_Tlmr_DFFprim (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg Qtemp, last_CK;
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_DFFprim_blocking (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg last_CK;
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_DLATprim (SET,CLR,CK,D,Q);
output reg Q;
input D,SET,CLR,CK;
reg Qprev;
...
module ST_SPHD_HIPERF_2048x32m8_Tlmr_SWprim (control,in,out);
output out;
input control,in;
